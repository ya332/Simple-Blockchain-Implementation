...
IMPORTANT--X sensor and LB are not connected to the same node.--IMPORTANT

Algorithm
1.When there is an intrusion, X will send signal to
BC. Intrusion detected.


2.When X is hacked, X will send signal to BC, but BC can't detect
the intrusion. X sensor signal and LB sensor signal will be different.
Intrusion detected.
